...
module: capstone
learningObjectives:
  - Understand the complete autonomous humanoid robot project requirements
  - Integrate all concepts from previous modules into a cohesive system
  - Apply best practices in robotics system architecture and design
  - Demonstrate proficiency in ROS 2, simulation, Isaac, and VLA systems
prerequisites:
...
- [Module 2: Simulation](../module-2-gazebo-unity/) - for simulation environment and testing
- [Module 3: Isaac Platform](../module-3-nvidia-isaac/) - for accelerated perception and navigation
- [Module 4: VLA Systems](../module-4-vla-systems/) - for vision-language-action integration